" Vim filetype detection file for Wikimedia (wikipedia) files.
"

au BufNewFile,BufRead *.wiki set filetype=wikimedia
au BufNewFile,BufRead *.*pedia.org set filetype=wikimedia
au BufNewFile,BufRead *.*pedia.org.tmp set filetype=wikimedia
